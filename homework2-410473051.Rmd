...
```{r ans26}
hour(allCommitDatesTW)=4 & minute(allCommitDatesTW)>=30 ->hm1
hour(allCommitDatesTW)=5 ->hm2
hour(allCommitDatesTW)=6 & minute(allCommitDatesTW)<=30 ->hm3
logicWithinTimeFrame <- hm1|hm2|hm3
...
```{r ans32}
#transcriptData[[3]]
str_detect(transcriptData[[3]],"經濟學系") ->logicFromEcon
logicFromEcon
```
...
```{r ans34}
transcriptPartialData & logicFromEcon ->transcriptPartialDataEcon
